...
func (h *CategoryHandler) ListCategories(c *gin.Context) {
	...
	for _, c := range list {
		resp = append(resp, categoryResponse{ID: c.ID, Title: c.Title, Description: c.Description})
	}
...
func (h *CategoryHandler) GetCategory(c *gin.Context) {
	...
	c.JSON(http.StatusOK, categoryResponse{ID: cat.ID, Title: cat.Title, Description: cat.Description})
}
...
func (h *CategoryHandler) CreateCategory(c *gin.Context) {
	...
	c.JSON(http.StatusCreated, categoryResponse{ID: id, Title: req.Title, Description: req.Description})
}
